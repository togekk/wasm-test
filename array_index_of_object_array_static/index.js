...
MyCode().then(Module => {
    ...
    const obj_heap = send_string(string_object);
    mod._getObjectFromJS(obj_heap, string_object.length, Object.keys(string_object).length);             // call c function with memory address
})
