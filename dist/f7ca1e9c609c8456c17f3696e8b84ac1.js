...
var instantiateStreaming = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(response, imports) {
    var module;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", instantiate(module, imports));
    ...
    if (hash >= 0) {
      ...
      if (typeof classElem === "undefined" || !classElem.prototype) {
        var ctor = function ctor() {
          ...
          return ctor.wrap((_ctor$prototype = ctor.prototype).constructor.apply(_ctor$prototype, arguments));
        };
        ctor.prototype = {};
      ...
      } else curr[name] = function () {
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        return elem.apply(undefined, [this.this].concat(args));
      };
    } else {
      if (/^(get|set):/.test(name)) {
        if (!hasOwnProperty(curr, name = name.substring(4))) {
...
},{"base64-js":10,"ieee754":9,"isarray":8,"buffer":6}],4:[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var myModule = get_module();
var a = ['David', 'John', 'Simon', 'Gavin', 'Darren'];
var b = ['Simo', 'Gavn', 'aaaaa', 'gggg'];
var ptr_arr = new Array();
for (var i = 0; i < a.length; i++) {
    ptr_arr.push(myModule.newString(a[i]));
}var ptr_arr_2 = new Array();
for (var _i = 0; _i < b.length; _i++) {
    ptr_arr_2.push(myModule.newString(b[_i]));
}var result = myModule.compare_string(ptr_arr[0], ptr_arr_2[0], ptr_arr.length, ptr_arr_2.length);
console.log(result);

function get_module() {
    var fs = require('fs');
    var loader = require("./assemblyscript/lib/loader");
    var compiled = new WebAssembly.Module(Buffer('', 'base64'));
    var imports = {};
    var myModule = loader.instantiate(compiled, imports);
    myModule.reset_memory();
    return myModule;
}
},{"fs":5,"./assemblyscript/lib/loader":7,"buffer":6}],11:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/f7ca1e9c609c8456c17f3696e8b84ac1.map