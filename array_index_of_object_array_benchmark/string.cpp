...
void getObjectFromJS(string key_2, string value, int object_length)
{
    key.push_back(key_2);
...
int arrayIndexOf(string key_2, string value, int array_length, int object_length)
{
    int id_found;
    int count;
    ...
    for (int i = 0; i < array_length; i++)
    {
        ...
        {
            if (obj[make_pair(i, key_2)] == value)
            {
                id_found = value_id;
                break;
            }
